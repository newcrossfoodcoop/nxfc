...
seneca.use(path.resolve('./modules/products/worker/actions/ingests.worker.actions'));
...
exports.run = function(req, res, next) {
    seneca.act({role: 'ingest', cmd: 'run', ingestId: req.ingest._id, limit: req.query.limit}, function(err, result) {
        if (err) {
